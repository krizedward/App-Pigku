...
<div class="row align-items-center mb-4">
    <div class="col">
        <h1 class="h3 mb-0 text-gray-800">Pengeluaran ( {{ \Carbon\Carbon::parse($date)->locale('id')->translatedFormat('d F Y') }} )</h1>
    </div>
    <div class="col-auto ms-auto">
        <a class="btn btn-primary btn-icon-split" href="{{ route('expense.list.create', $date) }}">
                    ...
                    <table class="table table-striped table-bordered mb-0" id="event-table" width="100%"
                        ...
                        <tbody id="event-table-body">
                            ...
                            <tr>
                                ...
                                <td>{{ $expense->note_expense ?? '-' }}</td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="4" class="text-center">Belum ada order di tanggal ini</td>
                            </tr>
                            @endforelse
                        </tbody>
                        @if($expenses->count() > 0)
                        <tfoot>
                            <tr>
                                <th colspan="2" class="text-end">Total Semua</th>
