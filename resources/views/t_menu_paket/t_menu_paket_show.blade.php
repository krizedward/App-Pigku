...
@section('title', 'Paket Menu Detail')
...
<div class="row align-items-center mb-4">
  ...
  <div class="col-auto ms-auto">
    <a class="btn btn-primary btn-icon-split" href="{{ route('menu.index') }}">
          ...
          <table class="table table-striped table-bordered mb-0" id="event-table" width="100%" cellspacing="0">
            <thead>
              <tr>
                ...
                <th style="text-align: center;vertical-align: middle;">Jumlah Menu Paket</th>
