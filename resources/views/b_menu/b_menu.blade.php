          ...
          <table class="table table-striped table-bordered mb-0" id="event-table" width="100%" cellspacing="0">
            <thead>
              <tr>
                ...
                <th style="text-align: center;vertical-align: middle;">Host</th>
                <th style="text-align: center;vertical-align: middle;">Update URL</th>
            ...
            <tbody id="event-table-body">
              @foreach ($datas as $index => $data)
                <tr>
                  ...
                  <td>{{ $data->menu_category_code }}</td>
                  <td>{{ $data->menu_name }}</td>
                  <td>{{ $data->menu_host }}</td>
                  <td>{{ $data->update_url }}</td>
                  ...
                  <td>
                    <form action="{{ route('master-menu.toggle', $data->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
