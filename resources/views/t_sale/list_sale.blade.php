    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">{{ \Carbon\Carbon::parse($date)->locale('id')->translatedFormat('d F Y') }}</h6>
                    ...
                    <table class="table table-striped table-bordered mb-0" id="event-table" width="100%"
                        ...
                        <tbody id="event-table-body">
                            ...
                            <tr>
                                ...
                                <td>Rp{{ number_format($order->price_menu,0,',','.') }}</td>
                            ...
                            @empty
                            <tr>
                                <td colspan="6" class="text-center">Belum ada order di tanggal ini</td>
                            </tr>
                            @endforelse
                        </tbody>
                        @if($orders->count() > 0)
                        <tfoot>
                            <tr>
                                <th colspan="4" class="text-end">Total Semua</th>
