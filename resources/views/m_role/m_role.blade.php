...
<div class="row align-items-center mb-4">
  ...
  <div class="col-auto ms-auto">
    <a class="btn btn-primary btn-icon-split" href="{{ route('master-role.create') }}">
            ...
            <tbody id="event-table-body">
              @foreach ($datas as $index => $data)
                <tr>
                  ...
                  <td colspan="2">
                    <div class='d-flex'>
                      <a class='btn btn-sm btn-warning mr-2' href="{{ route('master-role.edit', $data->id) }}"><i class='fa fa-edit'></i></a>
                      <form action="{{ route('master-role.destroy', $data->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
