...
@if(Auth::user()->t_pengguna->t_role->m_role->id == 1)
  ...
  <div class="row">
    <div class="col-xl-12 col-lg-12">
      <form method="GET" action="{{ route('dashboard.main') }}">
        <div class="row align-items-end mb-3">

          <div class="col-xl-4 col-lg-4 col-md-6 mb-3">
            <label for="bulan">Bulan:</label>
            <select class="form-control" name="bulan" id="bulan">
              @for ($i = 1; $i <= 12; $i++) <option value="{{ $i }}" {{ $i == $bulan ? 'selected' : '' }}>
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <div class="mt-4 text-center small">
            ...
            <span class="mr-2">
              <i class="fas fa-circle text-info"></i> Add-On
            </span>
          </div>
        </div>
    </div>
  ...
  <script>
    ...
    var myPieChart = new Chart(ctx, {
      type: 'doughnut',
      data: {
        labels: ["Makanan", "Minuman", "Add-On"],
        datasets: [{
          // data: [55, 30, 15],
          data: @json($dataPieDemo),
        ...
        scales: {
          ...
          yAxes: [{
            ticks: {
              ...
              // Include a dollar sign in the ticks
              callback: function(value, index, values) {
                return number_format(value) + ' Porsi';
              }
            },
            gridLines: {
              color: "rgb(234, 236, 244)",
